      ...
      // StoreHub API Controller 1
      const express = require('express');
      const mongoose = require('mongoose');
      const moment = require('moment');
      
      function OrdersApiController() {
        var self = this;
        ...
        this.list = function(req, res) {
          ...
          mongoose.model('Order').find(query, function(err, items) {
            if (err) {
        ...
        this.create = function(req, res) {
          ...
          var newItem = new (mongoose.model('Order'))({
        ...
        this.update = function(req, res) {
          ...
          mongoose.model('Order').findOneAndUpdate(
