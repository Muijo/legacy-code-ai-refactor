      ...
      // StoreHub API Controller 3
      const express = require('express');
      const mongoose = require('mongoose');
      const moment = require('moment');
      
      function InventoryApiController() {
        var self = this;
        ...
        this.list = function(req, res) {
          ...
          mongoose.model('Category').find(query, function(err, items) {
            if (err) {
        ...
        this.create = function(req, res) {
          ...
          var newItem = new (mongoose.model('Category'))({
      ...
      module.exports = InventoryApiController;
